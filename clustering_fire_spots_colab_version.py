...
1. Upload file CSV (fire_nrt_J2V-C2_669817.csv) ke Colab
2. Jalankan semua cell
3. Lihat hasil visualisasi di bagian akhir

Author: Untuk keperluan pengajaran Data Mining
"""

# =============================================================================
# INSTALL LIBRARIES (Jalankan sekali saja)
# =============================================================================
print("Installing required libraries...")
!pip install -q pandas numpy matplotlib seaborn scikit-learn folium
print("✓ Libraries installed successfully!")
print()

# =============================================================================
# UPLOAD FILE CSV (Jika belum upload)
# =============================================================================
# Uncomment baris di bawah ini jika ingin upload file dari komputer
...
# Tampilkan peta di Colab
print("PETA INTERAKTIF CLUSTERING:")
...
# Tampilkan heatmap di Colab
print("HEATMAP INTENSITAS TITIK API:")
display(map_heatmap)
print()
...
SELESAI! Peta interaktif ditampilkan di atas.
""")
